...
function Services() {
  return (
    <div className="bg-[url('/images/bg.png')] bg-cover bg-center bg-no-repeat h-full py-16  lg:px-20  max-[1024px]:px-0 max-[640px]-auto">
      <h2 className="text-4xl font-normal text-center text-white font-[inter-tight]">
        My Services
      </h2>

      <p className="text-2xl font-normal text-center text-white font-[inter-tight] mt-4 mb-16 max-[640px]:text-xl">
