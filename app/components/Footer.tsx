        ...
        <div className="grid w-full grid-cols-1 gap-10 text-center sm:grid-cols-2 md:grid-cols-3 lg:w-3/5 lg:text-left">
          ...
          <div className="flex flex-col font-normal text-sm text-[#1A1B1F] gap-3 items-start lg:items-start md:text-start ">
            ...
            <Link className="flex gap-2" href={"/"}>
              See all resources <ArrowRight className="text-[#1A1B1F] w-4" />
            </Link>
          </div>
        </div>
      </div>
      <hr className="my-6 text-[#E0E0E0] " />
      <div className="flex flex-col items-center gap-2 md:flex-row md:justify-between lg:justify-between">
        <p className="font-normal text-sm text-[#222227]">
          © 2025 Ebrahim Elgendy
        </p>
        <div className="flex ">
          <Link href={"/"}>
            {" "}
