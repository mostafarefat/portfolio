...
function Guides() {
  return (
    <section className='px-20 py-16 max-[1024px]:px-10 max-[640px]:px-5'>
      ...
      {/* CARDS */}
      <ul
        className='grid grid-cols-1 gap-6 mx-20 mb-12 text-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'
      >
        <li>
          <Link href={""}>
            <Image src={"/images/Component1.svg"} alt='card' width={400} height={490} className='mx-auto'/>
          </Link>
        </li>

        <li>
          <Link href={""}>
            <Image src={"/images/Component2.svg"} alt='card' width={400} height={490} className='mx-auto'/>
          </Link>
        </li>

        <li>
          <Link href={""}>
            <Image src={"/images/Component3.svg"} alt='card' width={400} height={490} className='mx-auto'/>
          </Link>
        </li>
      </ul>
